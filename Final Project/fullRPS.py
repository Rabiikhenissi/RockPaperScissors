...
def chooseMode():
  ...
  try:
    ...
    print("What Mode do you want to play in? 1: beginner, 2: intermediate, 3: expert, or 4: super hard? Enter a number \n")
    mode =  executecamera()
  ...
  if(mode > 4 and mode != 73):
    ...
    while(mode > 4 and mode != 73):
      try:
        print("What Mode do you want to play in? 1: begginner, 2: intermediate, 3: expert, or 4: super hard? Enter a number \n")
        mode =  executecamera()
      except ValueError:
        print("you must enter an integer \n")
  return mode
...
def easyMode():
  ...
  while(continuePlaying):
    try:
      print(("Rock,Paper,Scissors,  3 Fingers to exit \n"))
      choice = executecamera()
    except ValueError:
      print("you must enter an integer \n")
